...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/harun/capstone/username')
    password_param = ssm.get_parameter(Name="/harun/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'harun-capstone-rds.cim5ypdx3sul.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'harun-static-capstone' # please enter your s3 bucket name
